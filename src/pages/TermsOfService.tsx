        ...
        <Layout>
            ...
            <div className="policy-content-wrapper">
                <div className="policy-content">
                    ...
                    <div className="policy-section">
                        <h3>5. AMENDMENT & CANCELLATION POLICY</h3>
                    ...
                    <div className="policy-section">
                        <h3>6. ACCURACY OF PRICES & DESCRIPTIONS</h3>
                    ...
                    <div className="policy-section">
                        <h3>7. OUR RESPONSIBILITY FOR YOUR BOOKING</h3>
                    ...
                    <div className="policy-section">
                        <h3>9. VISA, PASSPORT AND HEALTH REQUIREMENTS</h3>
                    ...
                    <div className="policy-section">
                        <h3>10. UNAUTHORISED USE OF SERVICES</h3>
                    ...
                    <div className="policy-section">
                        <h3>14. APPLICABLE LAW AND JURISDICTION</h3>
