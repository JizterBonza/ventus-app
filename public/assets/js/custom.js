...
$(document).ready(function () {
    ...
    owl.on('changed.owl.carousel', function (event) {
        ...
        $('.header .owl-carousel span').removeClass('animated fadeInUp');
        $('.header .owl-carousel h4').removeClass('animated fadeInUp');
        $('.header .owl-carousel h1').removeClass('animated fadeInUp');
        $('.header .owl-carousel p').removeClass('animated fadeInUp');
        $('.header .owl-carousel .butn-light').removeClass('animated fadeInUp');
        $('.header .owl-carousel .butn-dark').removeClass('animated fadeInUp');
